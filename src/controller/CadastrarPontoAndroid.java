		...
		switch (acao) 
		{
			case "Cadastrar":
				...
				try 
				{
					...
					if(hora == null){hora = "";}
					String dataEscolhida = retornaDataAtual(); // pega dia que est� batendo o ponto
					...
					if(pontoTO != null) // altera os dados do "dia" at� que este seja finalizado
					{
						...
						if(finalizarDia != "")
						{
							...
							else 
							{
								...
								else // caso tenha batido o ponto errado, o hor�rio final vai se alterando
								{
									horaSaida = hora;
								}
