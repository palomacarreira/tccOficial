...
<div class="container">
	...
	<label  for= "dadosEmpregado" > Dados Empregado </label></br> </br>
		 ...
		 <div  class= "form-group" > 
		    ...
		    <div class="span3">
		    <input type="text" id="dataNasc" name="dataNasc" class="form-control" size="20"> 
		    </div>
		 </div>
    ...
    <div class="container">
        ...
        <div  class= "form-group" > 
		    ...
		    <div class="span3">
		    <input type="text" id="dataAdmissao" name="dataAdmissao" class= "form-control" size="20"> 
		    </div>
		 </div>
	   ...
	   <div  class= "form-group" > 
		...
		<div  class= "form-group" > 
		 ...
		 <div>
		  ...
		  <div>
     		 <label  for= "regimeContrato" > Regime de contrato</label> 
     		 <div class="span3">
 				<select class="form-control" name="regimeContrato" id="regimeContrato">
					<option value="salario" style ="width: 100px; height: 100px">Acréscimo de salário</option>	
		 ...
		 <label  for= "compensacaoDias" > Compensação de dias de trabalho </label> 
  		<div class="span3">
   				 <input  type= "radio"  name= "compensacaoDias"  id= "salario"  value= "Salário" >
   			 Salário
   			 </br>
  				<input  type= "radio"  name= "compensacaoDias"  id= "horasTrabalhadas"  value= "Horas Trabalhadas" >
  			 Horas Trabalhadas
  			 </br>
  			</div>
		</div> 
      	...
      	<div  class= "radio form-group" > 
      	 <label  for= "regimeTrabalho" > Regime de tempo de trabalho </label> 
  			<div class="span3">
   				 <input  type= "radio"  name= "regimeTrabalho"  id= "radioFem"  value= "Tempo Integral" >
   			 Tempo Integral(44hrs semanais)
   			 </br>
  				<input  type= "radio"  name= "regimeTrabalho"  id= "radioMasc"  value= "Tempo Parcial" >
       ...
       <div  class= "form-group " > 
		    ...
		    <div class="span3">
		    <input  type= "text"  class= "form-control" name="horaEntrada" id= "horaEntrada" size="5"> 
		    </div>
	   </div>
	   <div  class= "form-group" > 
		    <label  for= "senha" > Saida Almoço </label> 
		    <div class="span3">
		    <input  type="text"  class= "form-control" name="horaSaidaAlmoco" id="horaSaidaAlmoco" size="5"> 
		    </div>
		</div>
		<div  class= "form-group" > 
		    <label  for= "senha" > Volta Almoço </label> 
		    <div class="span3">
		    <input  type="text"  class= "form-control" name="horaVoltaAlmoco" id="horaVoltaAlmoco" size="5"> 
		    </div>
		</div>
		<div  class= "form-group" > 
		    <label  for= "senha" > Saida </label> 
		    <div class="span3">
		    <input  type="text"  class= "form-control" name="horaSaida" id="horaSaida" size="5"> 
		    </div>
		</div>
    </div>
     </br>
	...
	<div id="foto">
	<input type="file" id="fotoEmpregado" name="fotoEmpregado">
	</div>
