...
CREATE TABLE IF NOT EXISTS `projetoTCC`.`FERIAS` (
  ...
  `PERIODO_AQUISITIVO_INICIO` DATETIME NOT NULL COMMENT 'REFERENCIA DE QUAL DATA INICIO DE PERIODO TRABALHADO SE REFERE ESTAS FERIAS',
  `PERIODO_AQUISITIVO_FIM` DATETIME NOT NULL COMMENT 'REFERENCIA DE QUAL DATA FINAL DE PERIODO TRABALHADO SE REFERE ESTAS FERIA',
  `SITUACAO` CHAR NULL COMMENT 'INFORMA SE O EMPREGADO POSSUI FERIAS VENCIDAS OU CONCLUIDAS',
...
CREATE TABLE IF NOT EXISTS `projetoTCC`.`FOLHA_PAGAMENTO` (
  ...
  `VALOR_HORA_EXTRA` DECIMAL(10,2) NULL COMMENT 'INFORMA O VALOR DAS HORAS EXTRAS',
