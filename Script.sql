...
CREATE TABLE IF NOT EXISTS `projetoTCC`.`FERIAS` (
  ...
  `VALOR` CHAR NULL COMMENT 'VALOR DAS FÉRIAS',
  `DATA_PAGAMENTO` DATE NULL COMMENT 'VALOR DAS FÉRIAS',
...
CREATE TABLE IF NOT EXISTS `projetoTCC`.`PONTO` (
  ...
  `FALTA` BOOLEAN NULL COMMENT 'INFORMA SE O EMPREGADO FALTOU NO DIA',
  `FALTA_JUSTIFICADA` BOOLEAN NULL COMMENT 'INFORMA SE A FALTA FOI JUSTIFICADA',
